...
export default {
    ...
    methods: {
        ...
        // Check if trimmed 'updatedTodo' value is not empty and emit it to the 'save-todo' event with the trimmed value to the parent component, then clear the error message. Otherwise, set the 'errorMessage'.
        onSaveTodo() {
            ...
            if (trimmedTodo) {
                ...
                this.errorMessage = "Please enter a non-empty todo item.";
            }
        }
    }
};
